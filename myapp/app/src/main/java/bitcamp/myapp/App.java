...
public class App {
            ...
            try {
                ...
                if (command.equals("menu")) {
                    ...
                    if (menuTitle == null) {
                        ...
                        {
                            precessMenu(menuTitle, subMenus[menuNo-1]);
                        }else {
    ...
    static String prompt(String main) {
    ...
    static String getMenuTitle(int menuNo, String[] menus) {
        return isValidateMenu(menuNo, menus) ? mainMenus[menuNo - 1] : null;
    }

    static void precessMenu(String menuTitle, String[] menus)
    {
        ...
        while (true)
        {
           ...
           if(command.equals("menu")) {
               printSubMenu(menuTitle,menus);
               continue;
           } else if (command.equals("9")) { //이전메뉴 선택
               break;
           }
            try {
                int menuNo = Integer.parseInt(command);
                ...
                if (subMenuTitle == null) {
                    System.out.println("유요한 메뉴 번호가 아닙니다");
                }if(subMenuTitle.equals("등록a"))
                {
