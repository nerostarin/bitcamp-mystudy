...
public class BoardController {
    ...
    public String add(Board board, HttpSession session, @RequestParam("files") Part[] parts) throws Exception {
    ...
    public String delete(@RequestParam("no") int boardNo, HttpSession session) throws Exception {
    ...
    public String fileDelete(@RequestParam("fileNo") int fileNo, @RequestParam("boardNo") int boardNo, HttpSession session) throws Exception {
        User loginUser = (User) session.getAttribute("loginUser");
